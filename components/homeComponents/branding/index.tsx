...
export default function Branding () {
  return (
    <div className='bg-white lg:px-28 px-6 py-6'>
      <h1 className='text-black text-center md:text-start text-3xl md:text-4xl lg:text-5xl font-bold'> Our Branding Solutions </h1>
      
      <div className='grid lg:py-12 md:grid-cols-2 md:gap-4 md:justify-end md:items-end lg:gap-6'>
        <div>
            <h2 className='text-black text-2xl md:text-3xl lg:text-4xl font-bold py-6 cursor-pointer'> Graphic Design </h2>
            ...
            <p className='bg-black text-center p-4 px-8 rounded-full shadow-2xl my-4 shadow-black md:w-1/2 text-white'> Learn More </p>
            </Link>

        </div>

        <div>
            <h2 className='text-black text-2xl md:text-3xl lg:text-4xl font-bold py-6'> UI/UX Design </h2>
        ...
        <div>
            <h2 className='text-black text-2xl md:text-3xl lg:text-4xl font-bold py-6'> Web Development </h2>
        ...
        <div>
            <h2 className='text-black text-2xl md:text-3xl lg:text-4xl font-bold py-6'> Crypto Exchange </h2>
        ...
        <div>
            <h2 className='text-black text-2xl md:text-3xl lg:text-4xl font-bold py-6'> Virtual Assistant </h2>
        ...
        <div>
            <h2 className='text-black text-2xl md:text-3xl lg:text-4xl font-bold py-6'> IT Services </h2>
