    ...
    <div className="bg-white lg:px-28 px-6 py-6">
      <div className="md:flex justify-between">
        <div className="py-2 md:py-6">
          <h1 className="text-[#FB2B30] text-center text-3xl md:text-4xl lg:text-5xl font-bold md:text-left md:py-6">Our Mission</h1>
        ...
        <div className="py-6">
          <h1 className="text-[#FB2B30] text-center text-3xl md:text-4xl lg:text-5xl font-bold md:text-right md:py-6">Our Vision</h1>
      ...
      <div>
        <h1 className="text-[#FB2B30] text-center text-3xl md:text-4xl lg:text-5xl font-bold py-6 pt-12 md:py-10">Our Core Values</h1>

        <div className='py-8 grid md:grid-cols-2 gap-8'>
          <div className="text-center flex flex-col items-center md:items-start">
            <h2 className="py-2 px-8 lg:py-3 text-white bg-[#FF0909] text-sm md:text-lg lg:text-2xl font-normal rounded-full w-fit text-center justify-center" style={{ boxShadow: '0 0 5px #FF0909, 0 0 10px #FF0909, 0 0 20px #FF0909' }}>Innovation</h2>
            ...
            <h2 className="py-2 px-8 lg:py-3 text-white bg-[black] text-sm md:text-lg lg:text-2xl font-normal rounded-full w-fit text-center justify-center" style={{ boxShadow: '0 0 5px #FF0909, 0 0 10px #FF0909, 0 0 20px #FF0909' }}>Excellence</h2>
            ...
            <div className="text-center flex flex-col items-center md:items-start">
            <h2 className="py-2 px-8 lg:py-3 text-white bg-[#FF0909] text-sm md:text-lg lg:text-2xl font-normal rounded-full w-fit text-center justify-center" style={{ boxShadow: '0 0 5px #FF0909, 0 0 10px #FF0909, 0 0 20px #FF0909' }}>Empowerment</h2>
            ...
            <div className="text-center flex flex-col items-center md:items-end">
            <h2 className="py-2 px-8 lg:py-3 text-white bg-[black] text-sm md:text-lg lg:text-2xl font-normal rounded-full w-fit text-center justify-center" style={{ boxShadow: '0 0 5px #FF0909, 0 0 10px #FF0909, 0 0 20px #FF0909' }}>Collaboration</h2>
            ...
            <h2 className="py-2 px-8 lg:py-3 text-white bg-[#FF0909] text-sm md:text-lg lg:text-2xl font-normal rounded-full w-fit text-center justify-center" style={{ boxShadow: '0 0 5px #FF0909, 0 0 10px #FF0909, 0 0 20px #FF0909' }}>Integrity</h2>
