  ...
  return (
    <div className=' z-30 py-40 px-[20px] md:px-[30px] xl:px-[97px] bg-[#FB2B30]'>
      <div className='text-white'>
           ...
           <div className='my-8'>
                <p className='py-2 px-8 lg:py-3 text-white bg-[#D47F1A] text-sm md:text-lg lg:text-2xl font-normal rounded-full w-fit text-center justify-center'> Let’s Talk </p>
           </div>
      </div>
    </div>
  )
