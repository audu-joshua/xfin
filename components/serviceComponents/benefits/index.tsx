        ...
        <div className=' md:bg-[#252424] px-2 md:px-4 lg:px-6 rounded-3xl'>
            ...
            <div className='grid lg:py-12 md:grid-cols-2 gap-8 md:gap-10 md:justify-end md:items-end lg:gap-12'>
                <div className='bg-white md:rounded-2xl p-8 shadow-2xl shadow-black'>
                    <h2 className=' text-2xl md:text-2xl text-[#252424] font-bold'> Expert Solutions </h2>
                ...
                <div className='bg-white md:rounded-2xl p-8 shadow-2xl shadow-black'>
                    <h2 className=' text-2xl md:text-2xl text-[#252424] font-bold'> Ehnanced Effiency </h2>
                ...
                <div className='bg-white md:rounded-2xl p-8 shadow-2xl shadow-black'>
                    <h2 className=' text-2xl md:text-2xl text-[#252424] font-bold'> Scalable Growth </h2>
                ...
                <div className='bg-white md:rounded-2xl p-8 shadow-2xl shadow-black'>
                    <h2 className=' text-2xl md:text-2xl text-[#252424] font-bold'> Proactive Support </h2>
                ...
                <div className='bg-white md:rounded-2xl p-8 shadow-2xl shadow-black'>
                    <h2 className=' text-2xl md:text-2xl text-[#252424] font-bold'> Innovative Approach </h2>
                ...
                <div className='bg-white md:rounded-2xl p-8 shadow-2xl shadow-black'>
                    <h2 className=' text-2xl md:text-2xl text-[#252424] font-bold'> Trust and Reliability </h2>
