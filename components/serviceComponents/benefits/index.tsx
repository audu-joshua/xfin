...
export function Benefits() {
  return (
    <div className='bg-[rgb(227,225,225)] lg:px-28 px-6 py-6'>
        <div className=' md:bg-[#FB2B30] px-2 md:px-4 lg:px-6 rounded-3xl'>
            <h1 className='md:text-white text-[#FB2B30] md:pt-4 text-4xl md:text-4xl lg:text-6xl'> Benefits Of Working With Xifin Enterprise </h1>
            ...
            <div className='grid lg:py-12 md:grid-cols-2 gap-8 md:gap-10 md:justify-end md:items-end lg:gap-12'>
                <div className='bg-white md:rounded-2xl p-8 shadow-2xl shadow-black'>
                    <h2 className=' text-2xl md:text-2xl text-[#FB2B30] font-bold'> Expert Solutions </h2>
                ...
                <div className='bg-white md:rounded-2xl p-8 shadow-2xl shadow-black'>
                    <h2 className=' text-2xl md:text-2xl text-[#FB2B30] font-bold'> Ehnanced Effiency </h2>
                ...
                <div className='bg-white md:rounded-2xl p-8 shadow-2xl shadow-black'>
                    <h2 className=' text-2xl md:text-2xl text-[#FB2B30] font-bold'> Scalable Growth </h2>
                ...
                <div className='bg-white md:rounded-2xl p-8 shadow-2xl shadow-black'>
                    <h2 className=' text-2xl md:text-2xl text-[#FB2B30] font-bold'> Proactive Support </h2>
                ...
                <div className='bg-white md:rounded-2xl p-8 shadow-2xl shadow-black'>
                    <h2 className=' text-2xl md:text-2xl text-[#FB2B30] font-bold'> Innovative Approach </h2>
                ...
                <div className='bg-white md:rounded-2xl p-8 shadow-2xl shadow-black'>
                    <h2 className=' text-2xl md:text-2xl text-[#FB2B30] font-bold'> Trust and Reliability </h2>
