      ...
      <div className='text-white md:w-[65%]'>
           ...
           <div className='my-8 md:flex md:justify-between'>
            <div className='w-full'>
                ...
                <div className='w-full'>
                  <div>
                    <h2 className=' text-xl md:text-3xl lg:text-4xl font-bold py-4 text-[#FF0909]'>Tailored UI Design</h2>
                  ...
                  <div>
                    <h2 className=' text-xl md:text-3xl lg:text-4xl font-bold py-4 text-[#FF0909]'>Strategic UX Design</h2>
