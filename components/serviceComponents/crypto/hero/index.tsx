  ...
  return (
    <div className=' z-30 py-40 px-[20px] md:px-[30px] xl:px-[97px] bg-[#FB2B30]'>
      <div className='text-white'>
           ...
           <p className=' text-sm md:text-lg lg:text-2xl md:w-[60%] lg:w-[70%] font-normal'>Whether you're a seasoned trader or just starting out, we've got everything you need to navigate the exciting world of crypto. Sign up today and join the future of finance! </p>    
